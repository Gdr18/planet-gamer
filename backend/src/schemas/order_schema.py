...
class OrderSchema(ma.SQLAlchemyAutoSchema):
	...
	address_id = ma.Integer(required=True, data_key="addressId", validate=validate.Range(min=1,
	                                                                                     error="El campo 'addressId' debe ser un entero positivo mayor que 0."))
	user_id = ma.Integer(required=True, data_key="userId", validate=validate.Range(min=1,
